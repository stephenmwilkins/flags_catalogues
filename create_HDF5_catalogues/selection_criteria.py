...
class CEERS:
    ...
    def __init__(self, hf):
        ...
        self.criteria['CEERS_colours_v5'] = [
            ('photom/FLUX_277', op.gt, 50),
            ('pz/ceers/INT_ZGT4', op.gt, 0.9),
            ('pz/ceers/ZA', op.gt, 4.5),
            ('pz/ceers/CHIA', op.lt, 60),
        ...
        sn = {f: hf['photom/FLUX_'+f][:]/hf['photom/FLUXERR_'+f][:]
              for f in ['606', '814', '115', '150', '200', '277', '356', '444']}
        ...
        sn_opt2[0, (self.za < 6)] = 0.0 # -- for galaxies at z<6 we can ignore F606W
        sn_opt2[1, (self.za < 7)] = 0.0  # -- for galaxies at z<7 we can ignore F814W
        sn_opt2[2, (self.za < 9.9)] = 0.0  # -- for galaxies at z<10 we can ignore F115W
        sn_opt2[3, (self.za < 13.2)] = 0.0  # -- for galaxies at z<13 we can ignore F150W
